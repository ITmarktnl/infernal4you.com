			...
			<head>
				<xsl:choose>
					<xsl:when test="kml:kml">
						<title>Locations Sitemap - Infernal-capers.com</title>
					</xsl:when>
					<xsl:otherwise>
						<title>XML Sitemap - Infernal-capers.com</title>
					</xsl:otherwise>
				</xsl:choose>
				...
				<xsl:choose>
					<xsl:when test="kml:kml">
						...
						<div id="content">
							...
							<p class="expl">
								<a href="https://infernal-capers.com/sitemap_index.xml">&#8592; Sitemap Index</a>							</p>
